...
2.  **Dependencias:** Se tiene que tener un archivo requirements hecho para instalar todas las librerias necesarias para el funcionamiento del proyecto
...
1.  **Entorno Virtual (venv):**
    a. Se crea el entorno virtual de python
       mkvirtualenv --python=/usr/bin/python3.12 venv
    b. Se instalan dependencias
       pip install -r /home/crelatentt/EVA3-BACKEND-BRACAMONTE/requirements.txt
...
2.  **Hosts Permitidos:**
    # settings.py
    ALLOWED_HOSTS = ['crelatentt.pythonanywhere.com']
